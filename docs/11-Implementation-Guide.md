...
cp services/image-ingestion-service/.env.example services/image-ingestion-service/.env
cp services/vision-inference-service/.env.example services/vision-inference-service/.env
cp services/result-api-service/.env.example services/result-api-service/.env
cp services/labware-interface-service/.env.example services/labware-interface-service/.env
cp services/vision-capture-service/.env.example services/vision-capture-service/.env
