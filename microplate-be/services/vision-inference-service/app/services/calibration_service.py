"""
Calibration service to persist and apply ROI settings for grid building.
"""
...
class CalibrationService:
    """
    Manage calibration config used to rectify captured images.
    """
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self._config_format_version = 3  # เปลี่ยนเป็น v3 เพื่อใช้ pixel format
        self._load()
    ...
    def save(
        ...
        # Debug: แสดงค่าที่รับมาจาก frontend
        ...
        # เก็บค่า pixel ตรง ๆ แทนการ normalize
        config = {
            ...
            "format_version": 3,  # เปลี่ยนเป็น v3 เพื่อบอกว่าเก็บเป็น pixel
        }
        ...
        self._config = config  # Update memory cache
    ...
    def get_grid(self, frame_shape: Tuple[int, int]) -> Dict[str, List[float]]:
        ...
        # Reload config จากไฟล์ทุกครั้งเพื่อให้ได้ค่าล่าสุด
        self._load()
        ...
        # ถ้าเป็น format v3 = เก็บเป็น pixel ตรง ๆ ใช้ได้เลย
        if format_version == 3:
        ...
        # ถ้าเป็น format v2 เก่า = normalize แล้ว ต้องคำนวณกลับ
    ...
    # Methods removed: _normalize_bounds, _normalize_axis, _ensure_relative_axes
    # Format v3 ใช้ pixel ตรง ๆ ไม่ต้อง normalize
