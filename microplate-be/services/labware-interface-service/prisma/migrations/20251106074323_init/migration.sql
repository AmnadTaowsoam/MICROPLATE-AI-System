...
-- CreateTable
CREATE TABLE "labware_interface"."interface_file" (
    "id" UUID NOT NULL,
...
-- CreateIndex
CREATE INDEX "interface_file_sample_no_idx" ON "labware_interface"."interface_file"("sample_no");

-- CreateIndex
CREATE INDEX "interface_file_status_idx" ON "labware_interface"."interface_file"("status");
